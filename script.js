 function showTool(toolName) {
        ...
        function addBlock() {
            ...
            if (!data) {
                alert('Vui lòng nhập dữ liệu block!');
                return;
            }
            ...
            myBlockchain.chain.forEach(block => {
                html += `
                    <div class="blockchain-block">
                        ...
                        <strong>Hash:</strong> <span class="success">${block.hash.substring(0, 16)}...</span><br>
                        <strong>Previous Hash:</strong> ${block.previousHash.substring(0, 16)}...
                    </div>
                `;
            });
        ...
        function validateChain() {
            const valid = myBlockchain.isChainValid();
            const msg = valid 
                ? '<span class="success">✅ Blockchain HỢP LỆ!</span>' 
                : '<span class="error">❌ Blockchain BỊ GIẢ MẠO!</span>';
            document.getElementById('chainOutput').innerHTML = msg + document.getElementById('chainOutput').innerHTML;
        }
        
        // Init blockchain display
        displayChain();